...
export default function Tienda() {
  ...
  const marcasDisponibles = useMemo(
    () => [...new Set(productos.map((producto) => producto.marca).filter(Boolean))].sort(),
    [productos]
  )
  ...
  const alternarMarca = (marca) =>
    setMarcas((actuales) =>
      actuales.includes(marca) ? actuales.filter((item) => item !== marca) : [...actuales, marca]
    )
          ...
          <aside className="pc-store-sidebar">
            ...
            <div className="pc-sidebar-block">
              ...
              <label className="pc-filter-label" htmlFor="precio-max">
                Precio máximo<span>L {precioMax.toLocaleString('es-HN')}</span>
              </label>
              <input
                id="precio-max"
