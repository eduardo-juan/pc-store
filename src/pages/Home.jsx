    ...
    <main className="total-cinema-home">
      <section className="tc-intro">
        ...
        <div className="tc-intro-top">
          ...
          <span>HARDWARE WITHOUT LIMITS</span>
        </div>
        <div className="tc-intro-content">
          ...
          <p>
            Componentes seleccionados para equipos que no pasan desapercibidos.
          </p>
          <div className="tc-intro-actions">
            <Link to="/tienda" className="tc-gold-button">
              Explorar componentes <ArrowUpRight size={20} />
            </Link>
      ...
      <section className="tc-statement">
        ...
        <div>
          <span>NO ORDINARY COMPONENTS</span>
          <h2>
            Tu próxima PC
            <br />
            <i>empieza aquí.</i>
        ...
        <p>
          Encuentra rendimiento, diseño y fiabilidad en un catálogo creado para
          gamers, creadores y profesionales.
        </p>
      </section>
        ...
        <div className="tc-category-list">
          {categorias.map(([nombre, Icono], index) => (
            <Link to="/tienda" className="tc-category-row" key={nombre}>
              <span className="tc-index">0{index + 1}</span>
              <Icono />
              <h3>{nombre}</h3>
      ...
      <section className="tc-products">
        ...
        {cargando ? (
          <p className="tc-loading">Cargando selección...</p>
        ) : (
            ...
            {productos.slice(0, 6).map((producto, index) => (
              ...
              >
                ...
                <div className="tc-product-info">
                  <small>{producto.categorias?.nombre || "COMPONENTE"}</small>
