      ...
      <div className="pc-container">
        ...
        <div className="pc-page-heading">
          <div>
            ...
            <h1>Checkout</h1>
            <p>Completa los datos de entrega para generar tu orden.</p>
          </div>
        </div>
        ...
        <form className="pc-checkout-layout" onSubmit={finalizarCompra}>
          <section className="pc-card pc-checkout-form">
            ...
            <label>
              ...
              <textarea className="pc-textarea" rows="3" maxLength={150} value={direccion} onChange={(e) => setDireccion(e.target.value.slice(0, 150))} placeholder="Colonia, calle, casa, número, etc." required />
            </label>

            <label>
              Referencia de entrega <span style={{ color: 'red' }}>*</span>
              <input className="pc-input" type="text" maxLength={150} value={referencia} onChange={(e) => setReferencia(e.target.value.slice(0, 150))} placeholder="Ej. Casa con portón negro" required />
            </label>
            ...
            <div className="pc-card" style={{ padding: '16px', marginBottom: '20px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
                <div>
                  ...
                  <p className="pc-muted" style={{ margin: '4px 0 0' }}>Costo fijo de envío</p>
                </div>
                <strong>L {COSTO_ENVIO.toFixed(2)}</strong>
              </div>
            </div>

            <h2>Método de pago</h2>
            <select className="pc-select" value={metodoPago} onChange={(e) => setMetodoPago(e.target.value)}>
