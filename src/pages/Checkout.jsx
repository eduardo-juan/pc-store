...
export default function Checkout() {
  ...
  const finalizarCompra = async (e) => {
    ...
    if (!apellido.trim())
      return setError('Ingresa el apellido de la persona que recibirá el pedido.')
    if (!/^[0-9]{4}-[0-9]{4}$/.test(telefono))
      return setError('El teléfono debe tener el formato 9439-4343.')
        ...
        <form className="pc-checkout-layout" onSubmit={finalizarCompra}>
            ...
            <div className="pc-card" style={{ padding: '16px', marginBottom: '20px' }}>
              ...
              >
                <div>
                  ...
                  <p className="pc-muted" style={{ margin: '4px 0 0' }}>
                    Costo fijo de envío
                  </p>
                </div>
            ...
            {metodoPago === 'transferencia' && (
              <label>
                ...
                <input
                  ...
                  onChange={(e) => setReferenciaTransferencia(e.target.value.slice(0, 150))}
                />
              </label>
            )}
          ...
          <aside className="pc-card pc-summary">
            ...
            <div className="pc-summary-total">
              <span>Subtotal</span>
              <strong>L {subtotalNumerico.toFixed(2)}</strong>
            </div>
            <div
            ...
            <div className="pc-summary-total" style={{ fontSize: '1.15rem', marginTop: '12px' }}>
              <span>Total</span>
            ...
            <small className="pc-muted">
              La orden se publicará automáticamente para los empleados disponibles.
            </small>
          </aside>
        </form>
      </div>
