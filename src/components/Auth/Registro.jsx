...
export default function Registro() {
  ...
  const estiloError = (campo) => ({
    ...
    boxShadow: errores[campo] ? '0 0 0 3px rgba(220,38,38,.12)' : undefined,
  })

  return (
    <main className="pc-page">
      <div className="pc-container">
        <div className="pc-admin-header" style={{ textAlign: 'center', marginBottom: 24 }}>
          <h1>PC Store</h1>
          <p>Crea tu cuenta para comenzar a comprar.</p>
        </div>
        <div className="pc-card" style={{ maxWidth: 560, margin: '0 auto', padding: 28 }}>
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            ...
            <p style={{ marginTop: 8, color: '#64748b' }}>Completa tus datos para registrarte.</p>
          </div>
          {error && (
            <div
              className="pc-card"
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                value={form.teléfono}
                onChange={(e) => cambiar('teléfono', e.target.value)}
            ...
            <div>
              ...
              <small style={{ display: 'block', marginTop: 7, color: '#64748b' }}>
          ...
          >
            <p style={{ margin: 0, color: '#64748b' }}>¿Ya tienes una cuenta?</p>
            <Link
              to="/login"
