...
const limpiarNombreCategoria = (valor = '') =>
  String(valor)
    .replace(
      /[^a-zA-Z0-9áéíóúÁÉÍÓÚüÜñÑ\s_-]/g,
      '',
    )
    .slice(0, 80)

const limpiarDescripcion = (valor = '') =>
  String(valor).slice(0, 250)
...
export default function GestionCategorias() {
  ...
  const editarCategoria = (categoria) => {
    ...
    setNombre(
      limpiarNombreCategoria(categoria.nombre || ''),
    )
    setDescripcion(
      limpiarDescripcion(categoria.descripción || ''),
    )
    setError('')
  }
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                setNombre(
                  limpiarNombreCategoria(e.target.value),
                )
              }
              required
            />
            ...
            <input
              ...
              onChange={(e) =>
                setDescripcion(
                  limpiarDescripcion(e.target.value),
                )
              }
            />
