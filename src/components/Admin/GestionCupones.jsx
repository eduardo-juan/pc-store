...
export default function GestionCupones() {
  ...
  const guardar = async (e) => {
    ...
    const compraMinima = Number(
      form.compra_minima || 0,
    );

    const limiteUsos =
      form.limite_usos === ""
        ? null
        : Number(form.limite_usos);
    ...
    if (
      ...
      setError(
        "El límite de usos debe ser un número entero mayor que 0.",
      );
      return;
    }
  ...
  const eliminarCupon = async (cupon) => {
    if (!esAdmin) {
      setError(
        "No tienes permiso para eliminar cupones.",
      );
      return;
    }
    ...
    if (!data) {
      setError(
        "No se encontró el cupón para eliminar.",
      );
      return;
    }

    if (editandoId === cupon.id) {
      limpiar();
    }
    ...
    <main className="pc-page">
      <div className="pc-container">
        ...
        <div className="pc-admin-header">
          ...
          <p>
            Crea, modifica y activa promociones con
            código.
          </p>
        </div>
          ...
          >
            ...
            <div>
              ...
              <small
                style={{ color: "#666" }}
              >
                El cliente debe gastar al menos
                esta cantidad. Usa 0 si no hay
                mínimo.
              </small>
            </div>
            ...
            <div>
              ...
              <small
                style={{ color: "#666" }}
              >
                Déjalo vacío para permitir usos
                ilimitados.
              </small>
            </div>
