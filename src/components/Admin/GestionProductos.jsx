...
const limpiarTextoProducto = (valor, max = 120) =>
  valor
    .replace(/[^a-zA-Z0-9áéíóúÁÉÍÓÚüÜñÑ _-]/g, '')
    .slice(0, max)
...
const limpiarImagenes = async (producto) => {
  const rutas = obtenerRutasImagenesPropias(producto)
      ...
      if (imagenes.length > 0) {
        ...
        for (let i = 0; i < imagenes.length; i += 1) {
          ...
          if (!resultadoSubida.success) {
            throw new Error(resultadoSubida.error)
          }

          subidas.push(resultadoSubida.url)

          if (resultadoSubida.ruta) {
            nuevasRutas.push(resultadoSubida.ruta)
          }
        }
      ...
      if (esAdmin && productoId) {
        if (
          ...
          try {
            ...
            throw new Error(
              'El enlace del proveedor no es válido.',
            )
          }
          ...
          const proveedorResultado =
            await guardarProveedorProducto(productoId, {
            ...
            <form onSubmit={handleSubmit}>
              <div className="pc-form-grid">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setMarca(
                      limpiarTextoProducto(e.target.value, 60),
                    )
                  }
                />
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModelo(
                      limpiarTextoProducto(e.target.value, 80),
                    )
                  }
                />
                ...
                <div>
                  ...
                  >
                    La primera será la imagen principal y la segunda
                    la adicional. Se convierten a PNG transparente y se
                    guardan por categoría.
                  </small>
              ...
              {esAdmin && (
                ...
                >
                  ...
                  <p style={{ marginTop: 0 }}>
                    Información privada del proveedor. Solo los
                    administradores pueden verla.
                  </p>
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setDropshippingActivo(e.target.checked)
                      }
                    />
                  ...
                  {dropshippingActivo && (
                    <div className="pc-form-grid">
                      ...
                      <input
                        ...
                        value={urlProveedor}
                        onChange={(e) =>
                          setUrlProveedor(e.target.value)
                        }
                        required
                      />
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setCostoProveedor(e.target.value)
                        }
                        required
                      />
                    </div>
