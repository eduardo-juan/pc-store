...
export default function EmpleadoDashboard() {
  ...
  const cargarDatos = useCallback(async () => {
    ...
    const [
      ...
      supabase.rpc(
        'obtener_ordenes_disponibles_empleado',
      ),
    ...
    setMaxOrdenes(
      Number(config?.max_ordenes_activas) || 5,
    )

    setOrdenesDisponibles(
      disponiblesResult.data || [],
    )
        ...
        <div className="pc-page-heading">
          <div>
            ...
            <p style={{ color: '#171717' }}>
              Las nuevas órdenes aparecen aquí
              automáticamente. Elige las que quieras
              gestionar.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Todos los empleados activos reciben
                estas órdenes. El primero que la acepta
                la gestiona.
              </p>
            </div>
          ...
          {ordenesDisponibles.length === 0 ? (
            ...
            >
              No hay órdenes nuevas disponibles en este
              momento.
            </div>
          ) : (
            <div
