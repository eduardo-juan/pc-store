      ...
      <div className="pc-container">
        ...
        <div className="pc-page-heading">
          <div>
            ...
            <h1 style={{ color: '#171717' }}>Hola, {perfil?.nombre || 'Empleado'}</h1>
            <p style={{ color: '#171717' }}>
              Las nuevas órdenes aparecen aquí automáticamente. Elige las que quieras gestionar.
            </p>
          </div>
        </div>
        {error && (
        ...
        <div className="pc-metrics-grid">
          ...
          <article className="pc-card pc-metric">
            ...
            <strong style={{ color: '#171717' }}>L {metricas.comisiones.toFixed(2)}</strong>
          </article>
        </div>
        <section className="pc-card" style={{ padding: 20, marginBottom: 30 }}>
          ...
          >
            <div>
              <h2 style={{ margin: 0, color: '#171717' }}>
                <Bell size={20} style={{ verticalAlign: 'middle', marginRight: 7 }} />
                Nuevas órdenes
              </h2>
              <p className="pc-muted" style={{ margin: '5px 0 0' }}>
                Todos los empleados activos reciben estas órdenes. El primero que la acepta la
                gestiona.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <p style={{ margin: '5px 0', color: '#171717' }}>
                        {orden.nombre_cliente} {orden.apellido_cliente} · {orden.ciudad_envío}
                      </p>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      <button
                        ...
                        disabled={aceptando !== null || metricas.activas >= maxOrdenes}
